import { n as d, s as m } from './scheduler.e108d1fd.js';
const u = [];
function p(e, t = d) {
	let n;
	const o = new Set();
...
var g;
const E = ((g = globalThis.__sveltekit_127xz3v) == null ? void 0 : g.base) ?? '';
var k;
const w = ((k = globalThis.__sveltekit_127xz3v) == null ? void 0 : k.assets) ?? E,
	A = '1690551617818',
...
function N(e, t) {
	...
	return { url: n, external: r, target: o, download: i };
}
function z(e) {
	let t = null,
		n = null,
...
const V = { url: h({}), page: h({}), navigating: p(null), updated: R() };
export {
	I,
	_ as P,
	y as S,
